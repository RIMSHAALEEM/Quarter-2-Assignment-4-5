...
import testimonial1 from "@/public/tst1.jpeg"
import testimonial2 from "@/public/tst2.jpeg"
import testimonial3 from "@/public/tst3.jpeg"
import testimonial4 from "@/public/tst4.jpeg"
...
<div className="section">
    <h1 style={{color:"black", fontSize:"60px",textAlign:"center",fontWeight:"600px",fontFamily:"fantasy",paddingTop:"90px" }}>"Code the Future, <br />One Line at a Time!"
    </h1>
    ...
    <button className="btn">READ MORE ABOUT US</button></a>
...
<h1 className="what-about">Reviews By Our Clients</h1>
 
  {/* card 1  */}
  <div className="child-container">
    <div className="image-container">
    <Image className="blog-img-about" src={testimonial1 } alt="Review" ></Image>
    </div>
    <h2> Alice Josh</h2>
    <p className="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
       Distinctio deserunt voluptatem nihil suscipit saepe 
...
<div className="child-container ">
    <div className="image-container">
    <Image className="blog-img-about" src={testimonial2 } alt="Review" ></Image>
    </div>
    <h2>John Cardin</h2>
    <p className="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
       Distinctio deserunt voluptatem nihil suscipit saepe 
...
{/* card 3 */}
  <div className="child-container ">
    <div className="image-container">
    <Image className="blog-img-about" src={testimonial3} alt="Review" ></Image>
    </div>
    <h2>David Parker</h2>
    <p className="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
       Distinctio deserunt voluptatem nihil suscipit saepe 
  ...
  <div className="child-container ">
    <div className="image-container">
    <Image className="blog-img-about" src={testimonial4 } alt="Review"></Image>
    </div>
    <h2>Angie Mohtay</h2>
    <p className="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
       Distinctio deserunt voluptatem nihil suscipit saepe 
