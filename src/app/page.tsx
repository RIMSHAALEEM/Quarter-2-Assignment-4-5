...
<div className="section-home">
    <h1 style={{color:"black", fontSize:"60px",textAlign:"center",fontWeight:"600px",fontFamily:"fantasy" }}>"The art of programming <br />is the art of organizing complexity,<br /> of mastering multitude"
    </h1>
...
<div className="section-1 " >
  <h1 style={{color:"black", fontSize:"50px",textAlign:"left", marginLeft:"30px",marginTop:"15px"}}>Lorem Ipsum</h1>
  <p style={{color:"black", fontSize:"20px",textAlign:"left", marginLeft:"30px" ,justifyContent:"justify"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit.
